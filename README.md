# USER-Reduction
MSc Thesis project analysis pipeline of aDNA and USER Treatment . Supervised by Thorfinn Korneliussen (GLOBE Institute, Section for Geogenetics) and Hugh McColl (GLOBE Institute - Section for Geogenetics - Postdoc at Willerslev Group)
